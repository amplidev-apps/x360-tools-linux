class TranslationService {
  static const Map<String, Map<String, String>> strings = {
    ...
    "Aviso:": {"pt": "Aviso:", "en": "Warning:", "es": "Aviso:"},
    "Erro:": {"pt": "Erro:", "en": "Error:", "es": "Error:"},
    "Status:": {"pt": "Status:", "en": "Status:", "es": "Estado:"},
    "PHASE:": {"pt": "FASE:", "en": "PHASE:", "es": "FASE:"},
    "Unknown Step": {"pt": "Passo Desconhecido", "en": "Unknown Step", "es": "Paso Desconocido"},
    "Conecte-se ao Xbox no FTP Manager primeiro.": {"pt": "Conecte-se ao Xbox no FTP Manager primeiro.", "en": "Connect to Xbox in FTP Manager first.", "es": "Conéctese al Xbox en el Administrador FTP primero."},
    "Erro: Title ID não resolvido.": {"pt": "Erro: Title ID não resolvido.", "en": "Error: Title ID not resolved.", "es": "Error: Title ID no resuelto."},
    "Erro: Nenhum dispositivo selecionado.": {"pt": "Erro: Nenhum dispositivo selecionado.", "en": "Error: No device selected.", "es": "Error: Ningún dispositivo seleccionado."},
    "CANCELAR": {"pt": "CANCELAR", "en": "CANCEL", "es": "CANCELAR"},
    "Visualizador de Logs em breve!": {"pt": "Visualizador de Logs em breve!", "en": "Log Viewer coming soon!", "es": "¡Visor de registros próximamente!"},
    "DEFINIR NOME": {"pt": "DEFINIR NOME", "en": "SET NAME", "es": "DEFINIR NOMBRE"},
    "Digite o IP do Xbox.": {"pt": "Digite o IP do Xbox.", "en": "Enter Xbox IP.", "es": "Ingrese la IP de Xbox."},
    "EXTRACT TO PC": {"pt": "EXTRAIR PARA O PC", "en": "EXTRACT TO PC", "es": "EXTRAER AL PC"},
    "Arquivo launch.ini salvo com sucesso!": {"pt": "Arquivo launch.ini salvo com sucesso!", "en": "launch.ini file saved successfully!", "es": "¡Archivo launch.ini guardado con éxito!"},
    "CARREGAR .INI": {"pt": "CARREGAR .INI", "en": "LOAD .INI", "es": "CARGAR .INI"},
    "SALVAR NO USB": {"pt": "SALVAR NO USB", "en": "SAVE TO USB", "es": "GUARDAR EN USB"},
    ...
    "Aviso: Selecione um dispositivo para instalar a DLC.": {"pt": "Aviso: Selecione um dispositivo para instalar a DLC.", "en": "Warning: Select a device to install DLC.", "es": "Aviso: Seleccione un dispositivo para instalar el DLC."},
    "Erro: URL de download da DLC não encontrada.": {"pt": "Erro: URL de download da DLC não encontrada.", "en": "Error: DLC download URL not found.", "es": "Error: URL de descarga de DLC no encontrada."},
    "Erro ao buscar saves:": {"pt": "Erro ao buscar saves:", "en": "Error fetching saves:", "es": "Error al buscar partidas guardadas:"},
    "Importando Save/Perfil...": {"pt": "Importando Save/Perfil...", "en": "Importing Save/Profile...", "es": "Importando Partida/Perfil..."},
    "Apagando save...": {"pt": "Apagando save...", "en": "Deleting save...", "es": "Borrando partida..."},
    "Save removido.": {"pt": "Save removido.", "en": "Save removed.", "es": "Partida eliminada."},
    "Conectando ao Xbox (FTP)...": {"pt": "Conectando ao Xbox (FTP)...", "en": "Connecting to Xbox (FTP)...", "es": "Conectando al Xbox (FTP)..."},
    "Conectado via FTP ao Xbox!": {"pt": "Conectado via FTP ao Xbox!", "en": "Connected via FTP to Xbox!", "es": "¡Conectado vía FTP al Xbox!"},
    "FTP Desconectado": {"pt": "FTP Desconectado", "en": "FTP Disconnected", "es": "FTP Desconectado"},
    "Enviando arquivo via FTP...": {"pt": "Enviando arquivo via FTP...", "en": "Uploading file via FTP...", "es": "Enviando archivo vía FTP..."},
    "Envio concluído!": {"pt": "Envio concluído!", "en": "Upload complete!", "es": "¡Envío completado!"},
    "Erro de envio FTP": {"pt": "Erro de envio FTP", "en": "FTP upload error", "es": "Error de envío FTP"},
    "Atualizando dispositivos...": {"pt": "Atualizando dispositivos...", "en": "Refreshing devices...", "es": "Actualizando dispositivos..."},
    "Atualizando catálogo": {"pt": "Atualizando catálogo", "en": "Refreshing catalog", "es": "Actualizando catálogo"},
    "Buscando jogos": {"pt": "Buscando jogos", "en": "Fetching games", "es": "Buscando juegos"},
    "Lista de jogos carregada.": {"pt": "Lista de jogos carregada.", "en": "Game list loaded.", "es": "Lista de juegos cargada."},
    "E-mail e senha são obrigatórios.": {"pt": "E-mail e senha são obrigatórios.", "en": "Email and password are required.", "es": "El correo y la contraseña son obligatorios."},
    "Autenticando...": {"pt": "Autenticando...", "en": "Authenticating...", "es": "Autenticando..."},
    "Login concluído com sucesso!": {"pt": "Login concluído com sucesso!", "en": "Login completed successfully!", "es": "¡Login completado con éxito!"},
    "Selecione um dispositivo e carregue o arquivo launch.ini": {"pt": "Selecione um dispositivo e carregue o arquivo launch.ini", "en": "Select a device and load the launch.ini file", "es": "Seleccione un dispositivo y cargue el archivo launch.ini"},
    "Carregue o arquivo do seu pendrive para começar a editar.": {"pt": "Carregue o arquivo do seu pendrive para começar a editar.", "en": "Load the file from your USB drive to start editing.", "es": "Cargue el archivo de su pendrive para comenzar a editar."},
    "Caminhos de Inicialização (Paths)": {"pt": "Caminhos de Inicialização (Paths)", "en": "Initialization Paths (Paths)", "es": "Rutas de Inicio (Paths)"},
    "Boot Principal": {"pt": "Boot Principal", "en": "Main Boot", "es": "Boot Principal"},
    "Configurações de Rede e Sistema (Settings)": {"pt": "Configurações de Rede e Sistema (Settings)", "en": "Network & System Settings (Settings)", "es": "Ajustes de Red y Sistema (Settings)"},
    "Remover limite de Ping (System Link)": {"pt": "Remover limite de Ping (System Link)", "en": "Remove Ping limit (System Link)", "es": "Eliminar límite de Ping (System Link)"},
    "Remover limite de Conteúdo (DLC Patch)": {"pt": "Remover limite de Conteúdo (DLC Patch)", "en": "Remove Content limit (DLC Patch)", "es": "Eliminar límite de Contenido (DLC Patch)"},
    "Bloquear conexão com Xbox Live": {"pt": "Bloquear conexão com Xbox Live", "en": "Block Xbox Live connection", "es": "Bloquear conexión con Xbox Live"},
    "Bloquear servidores DNS da Microsoft": {"pt": "Bloquear servidores DNS da Microsoft", "en": "Block Microsoft DNS servers", "es": "Bloquear servidores DNS de Microsoft"},
    "Não sincronizar hora via NTP": {"pt": "Não sincronizar hora via NTP", "en": "Do not sync time via NTP", "es": "No sincronizar hora vía NTP"},
    "Habilitar comandos HTTP": {"pt": "Habilitar comandos HTTP", "en": "Enable HTTP commands", "es": "Habilitar comandos HTTP"},
    "Plugins Adicionais": {"pt": "Plugins Adicionais", "en": "Additional Plugins", "es": "Plugins Adicionales"},
    "Nota de Segurança: Certifique-se de que os plugins estejam instalados no dispositivo. Recomenda-se realizar um backup de segurança antes de aplicar alterações nas configurações do sistema.": {
      "pt": "Nota de Segurança: Certifique-se de que os plugins estejam instalados no dispositivo. Recomenda-se realizar um backup de segurança antes de aplicar alterações nas configurações do sistema.",
      "en": "Security Note: Make sure the plugins are installed on the device. It is recommended to perform a backup before applying changes to system settings.",
      "es": "Nota de Seguridad: Asegúrese de que los plugins estén instalados en el dispositivo. Se recomienda realizar una copia de seguridad antes de aplicar cambios en los ajustes del sistema."
    },
    ...
    "Gerencie suas partidas guardadas e perfis offline.": {"pt": "Gerencie suas partidas guardadas e perfis offline.", "en": "Manage your saved games and offline profiles.", "es": "Gestiona tus partidas guardadas y perfiles offline."},
    "IMPORTAR SAVE": {"pt": "IMPORTAR SAVE", "en": "IMPORT SAVE", "es": "IMPORTAR SAVE"},
    "BACKUP EM NUVEM": {"pt": "BACKUP EM NUVEM", "en": "CLOUD BACKUP", "es": "BACKUP EN LA NUBE"},
    "Fazer backup dos seus saves no Archive.org (Beta)": {"pt": "Fazer backup dos seus saves no Archive.org (Beta)", "en": "Backup your saves to Archive.org (Beta)", "es": "Hacer copia de seguridad de tus saves en Archive.org (Beta)"},
    "Backup individual": {"pt": "Backup individual", "en": "Individual backup", "es": "Copia de seguridad individual"},
    "Sincronizar tudo": {"pt": "Sincronizar tudo", "en": "Sync all", "es": "Sincronizar todo"},
    "CONECTAR": {"pt": "CONECTAR", "en": "CONNECT", "es": "CONECTAR"},
    "DESCONECTAR": {"pt": "DESCONECTAR", "en": "DISCONNECT", "es": "DESCONECTAR"},
    "IP DO XBOX": {"pt": "IP DO XBOX", "en": "XBOX IP", "es": "IP DEL XBOX"},
    "USUÁRIO": {"pt": "USUÁRIO", "en": "USER", "es": "USUARIO"},
    "SENHA": {"pt": "SENHA", "en": "PASSWORD", "es": "CONTRASEÑA"},
    "PASTA ATUAL:": {"pt": "PASTA ATUAL:", "en": "CURRENT FOLDER:", "es": "CARPETA ACTUAL:"},
    "ENVIAR ARQUIVO": {"pt": "ENVIAR ARQUIVO", "en": "UPLOAD FILE", "es": "ENVIAR ARCHIVO"},
    "CRIAR PASTA": {"pt": "CRIAR PASTA", "en": "CREATE FOLDER", "es": "CREAR CARPETA"},
    "REMOVER": {"pt": "REMOVER", "en": "REMOVE", "es": "ELIMINAR"},
    "Limpar Concluídos": {"pt": "Limpar Concluídos", "en": "Clear Completed", "es": "Limpiar Completados"},
    "Download iniciado:": {"pt": "Download iniciado:", "en": "Download started:", "es": "Descarga iniciada:"},
    "Title Update em download...": {"pt": "Title Update em download...", "en": "Title Update downloading...", "es": "Descarga de Title Update en curso..."},
    "TU Versão": {"pt": "TU Versão", "en": "TU Version", "es": "Versión TU"},
