...
from core.paths import get_user_data_dir, ensure_user_dirs

def main():
    # Ensure user data directories exist on startup
    ensure_user_dirs()
    ...
    try:
        if args.cmd == "list_drives":
            ...
            if args.id:
                temp_base = os.path.join(get_user_data_dir(), "freemarket", "install_temp")
            ...
            if not args.cookie:
                ...
                try:
                    cookie_path = os.path.join(get_user_data_dir(), "ia_cookie.txt")
